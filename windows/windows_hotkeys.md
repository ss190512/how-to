...
Win+F1: Windows help.
Ctrl+left or right arrow: Move cursor forward/back one word.
Ctrl+F4: Close active document(does not work for some applications).
Ctrl+F6: Cycle windows application windows.
Ctrl+Esc: Search.
...
Ctrl+Win+Left or right arrows: Switch virtual desktops in Windows 10.
